    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
        ...
        <div class="grid">
            <div class="col-12 md:col-4 mb-4 px-5">
                ...
                <span class="text-700 text-sm line-height-3">Duis aute irure dolor in reprehenderit in voluptate velit
            ...
            <div class="col-12 md:col-4 mb-4 px-5">
                ...
                <span class="text-700 text-sm line-height-3">Risus nec feugiat in fermentum posuere urna nec. Posuere
            ...
            <div class="col-12 md:col-4 mb-4 px-5">
                ...
                <span class="text-700 text-sm line-height-3">Ornare suspendisse sed nisi lacus sed viverra tellus. Neque
                    volutpat ac tincidunt vitae semper.sfs fdsf sdf sdf df sdf df sdfsd fdf sdfsdf sdf d</span>
            </div>
        </div>
    </div>
</template>
